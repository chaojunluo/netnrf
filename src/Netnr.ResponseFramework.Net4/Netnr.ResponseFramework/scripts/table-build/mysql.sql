...
CREATE TABLE `SysAuthorize`  (
  `SaId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `SuId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '关联SysUser表ID',
  `OpenId1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId2` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId4` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId3` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId5` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId6` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId7` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId8` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId9` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '第三方授权标识',
...
CREATE TABLE `SysButton`  (
  `SbId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `SbPid` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `SbBtnText` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '按钮文本',
  `SbBtnId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '按钮ID',
  `SbBtnClass` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '按钮类',
  `SbBtnIcon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '按钮图标',
  `SbBtnOrder` int(11) NULL DEFAULT 0 COMMENT '排序',
  `SbStatus` int(11) NULL DEFAULT 0 COMMENT '状态，1启用',
  `SbDescribe` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  `SbBtnGroup` int(11) NULL DEFAULT 0 COMMENT '分组',
...
CREATE TABLE `SysLog`  (
  ...
  `SuName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `SuNickname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `LogAction` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `LogContent` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `LogUrl` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `LogIp` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `LogCreateTime` datetime(3) NULL DEFAULT NULL,
  `LogBrowserName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `LogSystemName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `LogGroup` int(11) NULL DEFAULT 0,
  `LogRemark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `SysMenu`  (
  `SmId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `SmPid` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `SmName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `SmUrl` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '链接',
  `SmOrder` int(11) NULL DEFAULT 0 COMMENT '排序',
  `SmIcon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `SmStatus` int(11) NULL DEFAULT 0 COMMENT '状态，1启用',
  `SmGroup` int(11) NULL DEFAULT 0 COMMENT '分组，默认1，比如移动端为2',
...
INSERT INTO `SysMenu` VALUES ('2d5567ed-80d6-491c-b5e2-ef17babb3246', '2AE7FAF0-B627-4012-8A94-C5337579C8F5', '多表单生成', '/rf/buildforms', 4, 'fa-falg', 1, 1);
...
INSERT INTO `SysMenu` VALUES ('748d9667-bd7a-4745-be34-1057160ef444', '688BE98C-3D78-4B4D-A160-91476407599F', 'Grid多表格变动', '/rf/gridchange', 3, 'fa-flag', 1, 1);
...
CREATE TABLE `SysRole`  (
  `SrId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `SrName` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `SrStatus` int(11) NULL DEFAULT 0 COMMENT '状态，1启用',
  `SrDescribe` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  `SrGroup` int(11) NULL DEFAULT 0 COMMENT '分组',
  `SrMenus` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '菜单',
  `SrButtons` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '按钮',
  `SrCreateTime` datetime(3) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `SysTableConfig`  (
  ...
  `TableName` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '（虚）表名',
  `ColField` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '列键',
  `DvTitle` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '默认列标题',
  `ColTitle` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '列标题',
  `ColWidth` int(11) NULL DEFAULT 0 COMMENT '列宽',
  `ColAlign` int(11) NULL DEFAULT 0 COMMENT '对齐方式 1左，2中，3右',
  `ColHide` int(11) NULL DEFAULT 0 COMMENT '1隐藏',
  `ColOrder` int(11) NULL DEFAULT 0 COMMENT '排序',
  `ColFrozen` int(11) NULL DEFAULT 0 COMMENT '1冻结',
  `ColFormat` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '格式化',
  `ColSort` int(11) NULL DEFAULT 0 COMMENT '1启用点击排序',
  `ColExport` int(11) NULL DEFAULT 0 COMMENT '1导出',
  `ColQuery` int(11) NULL DEFAULT 0 COMMENT '1查询',
  `FormUrl` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '来源',
  `FormType` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '输入类型',
  `FormArea` int(11) NULL DEFAULT 0 COMMENT '区域',
  `FormSpan` int(11) NULL DEFAULT 0 COMMENT '跨列',
  `FormHide` int(11) NULL DEFAULT 0 COMMENT '1隐藏',
  `FormOrder` int(11) NULL DEFAULT 0 COMMENT '排序',
  `FormRequired` int(11) NULL DEFAULT 0 COMMENT '1必填',
  `FormPlaceholder` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '输入框提示',
  `FormValue` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '初始值',
  `FormText` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '显示文本',
...
-- ----------------------------
INSERT INTO `SysTableConfig` VALUES ('02A215E4-D1E7-428B-B159-72439B7C3BDB', 'sysuser', 'SuGroup', '分组', '分组', 100, 1, 2, 7, NULL, '0', NULL, 1, NULL, NULL, 'text', 1, 1, 2, 9, NULL, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('0ACF9D2C-92B8-44DB-801B-B2E11B2B5A95', 'tempexample', 'ColAlign', '默认值', '默认值', 130, 1, 0, 6, 0, '0', 0, 1, 1, 'dataurl_colalign', 'combobox', 1, 1, 0, 6, 0, '', '2', '');
INSERT INTO `SysTableConfig` VALUES ('0DDD0335-6A80-4927-B7EC-4BC9334606B2', 'tempexample', 'ColHide', '勾选1或0', '勾选1或0', 130, 1, 0, 2, 0, '0', 0, 1, 1, '', 'checkbox', 1, 1, 0, 2, 0, '', '', '勾选得到1不勾选为空');
...
INSERT INTO `SysTableConfig` VALUES ('10817844-1899-44E7-B41B-CD9EF4BC5465', 'tempexample', 'FormRequired', '1必填', '1必填', 130, 1, 0, 15, 0, '0', 0, 1, 1, '', 'checkbox', 1, 1, 0, 15, 0, '', '', '');
INSERT INTO `SysTableConfig` VALUES ('15B65F50-E47B-4A3A-9042-0F3B08487EAA', 'tempexample', 'FormValue', '选择角色', '选择角色', 130, 1, 0, 12, 0, '0', 0, 1, 1, '/setting/sysrole', 'modal', 1, 1, 0, 12, 1, '', '', '');
INSERT INTO `SysTableConfig` VALUES ('1638625D-601A-4FFD-8D7E-9904503C7543', 'tempexample', 'DvTitle', '时分秒', '时分秒', 130, 1, 0, 9, 0, '0', 0, 1, 1, '', 'time', 1, 1, 0, 9, 0, '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('1A9A7B9A-B6E6-4869-BF64-C0F90019B1F0', 'tempexample', 'ColQuery', '1查询', '1查询', 130, 1, 0, 19, 0, '0', 0, 1, 1, '', 'checkbox', 1, 1, 0, 19, 0, '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('1DBCFF81-4399-4FE3-8B34-68ABC051747A', 'tempexample', 'FormOrder', '排序', '排序', 130, 1, 0, 21, 0, '0', 0, 1, 1, '', 'text', 1, 1, 0, 21, 0, '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('2810CB41-3366-475F-B7D2-D3588F7ACE23', 'tempexample', 'FormHide', '1隐藏', '1隐藏', 130, 1, 0, 18, 0, '0', 0, 1, 1, '', 'checkbox', 1, 1, 0, 18, 0, '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('2f180f11-c6e1-11e8-98fc-aaaa0010af81', 'SysRole', 'SrDescribe', '角色描述', '角色描述', 200, 1, 0, 1, 0, '0', 0, 1, 0, '', 'text', 1, 2, 0, 2, 0, '', '', '');
INSERT INTO `SysTableConfig` VALUES ('2f180f46-c6e1-11e8-98fc-aaaa0010af81', 'SysRole', 'SrGroup', '角色分组', '角色分组', 100, 1, 2, 3, NULL, '0', NULL, 1, NULL, NULL, 'text', 1, 1, 2, 4, NULL, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('2f180fdf-c6e1-11e8-98fc-aaaa0010af81', 'SysRole', 'SrCreateTime', '创建时间', '创建时间', 100, 1, 2, 4, NULL, '0', NULL, 1, NULL, NULL, 'text', 1, 1, 2, 7, NULL, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('363b3f83-0caf-408b-8307-ae4cc6f298f5', 'sysuser', 'OldUserPwd', 'OldUserPwd', 'OldUserPwd', 100, 1, 2, 8, NULL, '0', NULL, 1, NULL, NULL, 'text', 1, 1, 2, 100, NULL, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('3F70197D-A228-4E08-98F8-79FE22E718E3', 'tempexample', 'FormType', '下拉树', '下拉树', 130, 1, 0, 0, 0, '0', 0, 1, 1, '/common/querymenu', 'combotree', 1, 1, 0, 0, 0, '', 'F8C1C161-F1FC-4729-A00C-4A9893BF8209', '');
INSERT INTO `SysTableConfig` VALUES ('459F9EC8-BD11-43E7-BEBB-A640714B5565', 'tempexample', 'FormArea', '默认多选', '默认多选', 130, 1, 0, 5, 0, '0', 0, 1, 1, 'dataurl_formarea', 'combobox', 1, 1, 0, 5, 0, '', '1,2', '');
...
INSERT INTO `SysTableConfig` VALUES ('6B2D1765-993D-4B31-B089-58675F98C09D', 'tempexample', 'ColTitle', '年月日', '年月日', 130, 1, 0, 8, 0, '0', 0, 1, 1, '', 'date', 1, 1, 0, 8, 0, '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('706D6A3F-7D2E-4327-82CD-6C49ACA44199', 'tempexample', 'ColSort', '默认勾选', '默认勾选', 130, 1, 0, 3, 0, '0', 0, 1, 1, '', 'checkbox', 1, 1, 0, 3, 0, '', '1', '默认选中');
...
INSERT INTO `SysTableConfig` VALUES ('7D63D1F1-884C-439D-A973-F68D8D3C8FC4', 'tempexample', 'FormUrl', '年月日时分秒', '年月日时分秒', 130, 1, 0, 7, 0, '0', 0, 1, 1, '', 'datetime', 1, 1, 0, 7, 0, '', '', '');
INSERT INTO `SysTableConfig` VALUES ('8E339D70-995D-4933-8056-C490CC5775A3', 'sysuser', 'SuSign', '登录标识', '登录标识', 100, 1, 2, 6, NULL, '0', NULL, 1, NULL, NULL, 'text', 1, 1, 2, 8, NULL, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('AF4EC19D-14D6-4046-BAED-7116BA4A0FA2', 'sysuser', 'SuStatus', '状态', '状态', 80, 2, 0, 5, NULL, '17', NULL, 1, NULL, NULL, 'checkbox', 1, 2, 0, 4, NULL, NULL, NULL, '启用账号');
INSERT INTO `SysTableConfig` VALUES ('B4AE0D0D-5F5D-4DAB-8591-672C3EB2A526', 'tempexample', 'ColOrder', '密码框', '密码框', 130, 1, 0, 14, 0, '0', 0, 1, 1, '', 'password', 1, 1, 0, 14, 0, '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('BCA1BBE4-44CA-4793-B214-99A6BF137F3E', 'tempexample', 'TableName', '文本域', '文本域', 130, 1, 0, 16, 0, '0', NULL, 1, 1, NULL, 'textarea', 1, 2, 0, 16, 1, '请输入表名', NULL, NULL);
INSERT INTO `SysTableConfig` VALUES ('C06F0970-9EEA-462F-9B1C-37782E450F05', 'tempexample', 'FormPlaceholder', '人员姓名', '人员姓名', 130, 1, 0, 10, NULL, '0', NULL, 1, 1, '/setting/sysuser', 'modal', 1, 1, 0, 10, 1, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('D3FB79B9-22C8-4DC1-BC0F-85C681BF7656', 'tempexample', 'FormSpan', 'combotree', 'combotree', 130, 1, 0, 1, 0, '0', 0, 1, 1, '/common/querymenu?custom=m', 'combotree', 1, 1, 0, 1, 0, '', '', '');
INSERT INTO `SysTableConfig` VALUES ('D52AE07E-7E03-4DCD-A7C3-9AE2BD614D64', 'tempexample', 'ColField', '必填项', '必填项', 130, 1, 0, 13, 0, '0', 0, 1, 1, '', 'text', 1, 1, 0, 13, 1, '请输入内容，必填', '', '');
INSERT INTO `SysTableConfig` VALUES ('DAE7AE2A-D6F1-487B-9863-F3A29920E023', 'tempexample', 'ColFrozen', '1冻结', '1冻结', 130, 1, 0, 20, 0, '0', 0, 1, 1, '', 'text', 1, 1, 0, 20, 0, '', '', '');
INSERT INTO `SysTableConfig` VALUES ('DAF45196-E710-4100-B517-01D0AA7454FB', 'sysuser', 'SuCreateTime', '创建时间', '创建时间', 180, 2, 0, 3, NULL, '0', NULL, 1, NULL, NULL, 'text', 1, 1, 1, 6, NULL, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('E158FE3F-9C66-48D3-BD76-DFA8C51EFE68', 'tempexample', 'FormText', '显示文本', '显示文本', 130, 1, 0, 22, 0, '0', 0, 1, 1, '', 'text', 1, 1, 0, 22, 0, '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('E8D0114E-63B3-41C4-99D0-5F9AF9EF79CC', 'tempexample', 'Id', 'Id', 'Id', 130, 1, 1, 1, NULL, '0', NULL, 1, NULL, NULL, 'text', 1, 1, 1, 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `SysTableConfig` VALUES ('F7A57E11-3B98-43F8-993A-47E6733C9F3C', 'tempexample', 'ColExport', '1导出', '1导出', 130, 1, 0, 17, 0, '0', NULL, 1, 1, NULL, 'checkbox', 1, 1, 0, 17, NULL, NULL, NULL, '导出');
INSERT INTO `SysTableConfig` VALUES ('F821E861-BB7B-4D20-915F-1B35EFA68ECC', 'tempexample', 'ColWidth', '人员账号', '人员账号', 130, 1, 0, 11, NULL, '0', NULL, 1, 1, '/setting/sysuser', 'modal', 1, 1, 0, 11, NULL, NULL, NULL, NULL);
INSERT INTO `SysTableConfig` VALUES ('FBEA8B72-B88A-4A24-B3DC-A9A5813BD9B2', 'tempexample', 'ColFormat', 'combobox', 'combobox', 130, 1, 0, 4, 0, '0', 0, 1, 1, 'dataurl_colformat', 'combobox', 1, 1, 0, 4, 0, '', '', '');
...
CREATE TABLE `SysUser`  (
  `SuId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `SrId` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '角色',
  `SuName` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '账号',
  `SuPwd` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '密码',
  `SuNickname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '昵称',
  `SuCreateTime` datetime(3) NULL DEFAULT NULL COMMENT '创建时间',
  `SuStatus` int(11) NULL DEFAULT 0 COMMENT '状态，1正常',
  `SuSign` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '登录标识',
  `SuGroup` int(11) NULL DEFAULT 0 COMMENT '分组',
