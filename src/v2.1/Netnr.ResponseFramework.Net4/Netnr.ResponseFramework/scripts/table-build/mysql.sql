...
CREATE TABLE `SysAuthorize` (
  ...
  `SysUserId` varchar(50) DEFAULT NULL COMMENT '用户表Id',
  `OpenId1` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId2` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId4` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId3` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId5` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId6` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId7` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId8` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  `OpenId9` varchar(50) DEFAULT NULL COMMENT '第三方授权标识',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id` (`Id`) USING BTREE,
  UNIQUE KEY `SysUserId` (`SysUserId`) USING BTREE
...
INSERT INTO `SysButton` VALUES ('e630bd97-8ea5-4551-ba0b-4d4600fa29e5', '00000000-0000-0000-0000-000000000000', '测试', 'm_Test', 'btn btn-sm btn-success', 'fa fa-ok', '1', '1', null, '1');
...
INSERT INTO `SysTableConfig` VALUES ('26DCC3C7-F5D8-4F4F-A525-61C7D97CB6F3', 'sysmenu', 'Pid', 'Pid', '上级菜单', '100', '1', '1', '1', null, '0', null, '1', null, '/Common/QueryMenu?type=all', 'combotree', '1', '1', '0', '1', null, null, null, null);
...
INSERT INTO `SysTableConfig` VALUES ('2B8BD8CC-2376-4E58-A6B5-B64FA07F1F20', 'sysmenu', 'Status', '状态，1启用', '状态', '60', '2', '0', '6', null, '17', null, '1', null, null, 'checkbox', '1', '1', '0', '5', null, null, '1', '启用菜单');
INSERT INTO `SysTableConfig` VALUES ('2efd71ce-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'Id', 'Id', 'Id', '100', '1', '1', '0', '0', '0', null, '1', null, null, 'text', '1', '1', '1', '1', null, null, null, null);
INSERT INTO `SysTableConfig` VALUES ('2efd72a6-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'Pid', '父ID', '上级按钮', '100', '1', '1', '1', null, '0', null, '1', null, '/Common/QueryButtonTree', 'combotree', '1', '1', '0', '1', null, null, null, null);
INSERT INTO `SysTableConfig` VALUES ('2efd72f0-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'BtnText', '按钮文本', '按钮文本', '200', '1', '0', '2', null, '0', null, '1', null, null, 'text', '1', '1', '0', '0', '1', null, null, null);
INSERT INTO `SysTableConfig` VALUES ('2efd7327-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'BtnId', '按钮ID', '按钮ID', '150', '1', '0', '3', null, '0', null, '1', null, null, 'text', '1', '1', '0', '2', '1', null, null, null);
INSERT INTO `SysTableConfig` VALUES ('2efd735a-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'BtnClass', '按钮类', '按钮类', '180', '1', '0', '4', null, '0', null, '1', null, null, 'text', '1', '1', '0', '3', null, null, null, null);
INSERT INTO `SysTableConfig` VALUES ('2efd738d-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'BtnIcon', '按钮图标', '按钮图标', '180', '1', '0', '5', null, '0', null, '1', null, null, 'text', '1', '1', '0', '4', '1', null, null, null);
INSERT INTO `SysTableConfig` VALUES ('2efd73bf-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'BtnOrder', '排序', '排序', '60', '2', '0', '6', '0', '0', '0', '1', '0', '', 'text', '1', '1', '0', '5', '0', '', '', '');
INSERT INTO `SysTableConfig` VALUES ('2efd73f0-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'Status', '状态，1启用', '状态', '60', '2', '0', '7', null, '17', null, '1', null, null, 'checkbox', '1', '1', '0', '6', null, null, '1', '启用按钮');
INSERT INTO `SysTableConfig` VALUES ('2efd7423-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'Describe', '描述', '描述', '100', '1', '0', '9', '0', '0', '0', '1', '0', '', 'text', '1', '2', '0', '8', '0', '', '', '');
INSERT INTO `SysTableConfig` VALUES ('2efd7452-c6e1-11e8-98fc-aaaa0010af81', 'SysButton', 'BtnGroup', '分组', '分组', '100', '2', '0', '8', null, '0', null, '1', null, null, 'text', '1', '1', '0', '7', '1', '默认1，不相同有分割线', null, null);
...
INSERT INTO `SysTableConfig` VALUES ('3B8F9087-86A5-4777-A56E-5D9C98F972A4', 'sysmenu', 'Url', '链接', '链接', '250', '1', '0', '3', '0', '0', '0', '1', '0', '', 'text', '1', '1', '0', '2', '0', '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('5A933E73-6FBE-486A-93D3-C53DD02F7161', 'sysmenu', 'Name', '名称', '名称', '250', '1', '0', '2', null, '0', null, '1', null, null, 'text', '1', '1', '0', '0', '1', null, null, null);
...
INSERT INTO `SysTableConfig` VALUES ('8F812FCE-E03D-4C68-BDD7-A3DE64AE38B9', 'sysmenu', 'MenuOrder', '排序', '排序', '60', '2', '0', '5', '0', '0', '0', '1', '0', '', 'text', '1', '1', '0', '4', '0', '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('BA169D09-3A4E-4480-A50E-A6B65F31D5E8', 'sysmenu', 'MenuGroup', '分组', '分组', '60', '2', '0', '7', '0', '0', '0', '1', '0', '', 'text', '1', '1', '0', '6', '0', '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('C2A8EE35-E805-46BF-BBF7-B09EA7101679', 'sysmenu', 'Id', 'Id', 'Id', '100', '1', '1', '0', '0', '0', '0', '1', '0', '', 'text', '1', '1', '1', '1', '0', '', '', '');
...
INSERT INTO `SysTableConfig` VALUES ('FEAE4BB7-4A5F-4F53-AE6B-996F08BE4471', 'sysmenu', 'Icon', '图标', '图标', '200', '1', '0', '4', null, '0', null, '1', null, null, 'text', '1', '1', '0', '3', '1', null, null, null);
