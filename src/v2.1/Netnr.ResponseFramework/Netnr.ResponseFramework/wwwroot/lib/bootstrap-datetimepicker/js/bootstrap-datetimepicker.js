...
(function ($) {
    ...
    DateTimePicker.prototype = {
        ...
        init: function (element, options) {
            ...
            if (this.$element.find('.form-control-feedback').length) {
            ...
            if (this.pickTime) {
                if (icon && icon.length) this.timeIcon = icon[0].className.replace('form-control-feedback', '');
                if (!this.timeIcon) this.timeIcon = 'fa fa-clock-o';
            }
            if (this.pickDate) {
                if (icon && icon.length) this.dateIcon = icon[0].className.replace('form-control-feedback', '');
        ...
        autoClose: function () {
            ...
            that.$element.blur(function () {
                if (document.activeElement && !that.widget[0].contains(document.activeElement)) {
                    that.hide();
                }
            });
            ...
            setTimeout(function () {
                $(window).on('click', function (e) {
                    ...
                    if (target != that.$element[0] && !that.widget[0].contains(target)) {
                        that.hide();
        ...
        place: function () {
            ...
            if (this.options.orientation == 'left') {
                ...
                offset.left = offset.left - this.widget.width() + 16;
            }
    ...
    function getTemplate(timeIcon, pickDate, pickTime, is12Hours, showSeconds, collapse) {
        if (pickDate && pickTime) {
            return (
                ...
                '</div>' +
                '</li>' +
                '<li class="picker-switch accordion-toggle"><a class="btn btn-default btn-block btn-lg"><i class="' + timeIcon + '"></i></a></li>' +
