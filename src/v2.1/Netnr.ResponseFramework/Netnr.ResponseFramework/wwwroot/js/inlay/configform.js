            ...
            if (target.nodeName == "I" && target.className.indexOf('ief') >= 0) {
                ...
                if (!z.ConfigForm.edit) {
                    ...
                    for (var i in formitem) {
                        htm.push('<div class="col-xs-12"><div class="form-group"><label class="col-xs-3 control-label required" style="width:auto">' + formitem[i] + '</label>');
                        htm.push('<div class="col-xs-8"><input class="form-control" id="' + z.ConfigForm.prefix + z.ConfigForm.formitem + i + '" name="' + i + '" /></div></div></div>');
                    }
                    htm.push('</form></div>');
