...
public static class ExpandFn
{
    ...
    public static Newtonsoft.Json.Linq.JObject ToUnJson(this string json)
    {
    ...
    #region 解析 JArray 里面的键转为字符串 null值返回空字符串
    ...
    /// <param name="jt"></param>
    /// <returns></returns>
    public static string ToTokenString(this Newtonsoft.Json.Linq.JToken jt)
    {
        try
        {
