...
namespace Netnr.Core
{
    ...
    {
        #region 验证码
        //public static void NewImg(string text)
        //{
        ...
        //{
        //    System.Drawing.Image ImgBox = System.Drawing.Image.FromFile(oldImgPath);
        ...
        //            break;
        //        case "cut":
        //            if ((double)ImgBox.Width / (double)ImgBox.Height > (double)minWidth / (double)minHeight)
        //            {
        ...
        //    //新建一个bmp图片
        //    System.Drawing.Image bitmap = new System.Drawing.Bitmap(minWidth, minHeight);
        ...
        //    graphic.DrawImage(ImgBox, new System.Drawing.Rectangle(0, 0, minWidth, minHeight), new System.Drawing.Rectangle(x, y, oldWidth, oldHeight), System.Drawing.GraphicsUnit.Pixel);
