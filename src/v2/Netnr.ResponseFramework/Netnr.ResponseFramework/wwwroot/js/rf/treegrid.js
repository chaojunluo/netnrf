//载入
var gd1 = z.Grid();
gd1.url = "/common/querydata?uri=sysmenu";
gd1.sortName = "MenuOrder";
gd1.type = "treegrid";
gd1.idField = "ID";
gd1.treeField = "Name";
gd1.onBeforeLoad = function (row, param) {
    ...
    sqitem1.value = "00000000-0000-0000-0000-000000000000";
...
gd1.onBeforeExpand = function (row) {
    ...
    gd1.func('options').url = "/RF/TreeGrid?id=" + row.ID;
