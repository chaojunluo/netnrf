...
CREATE TABLE `SysLog`  (
  ...
  `LogAction` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '动作',
  `LogContent` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '内容',
  `LogUrl` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '链接',
  `LogIp` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'IP',
  `LogCreateTime` datetime(3) DEFAULT NULL COMMENT '时间',
  `LogBrowserName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '浏览器名称',
  `LogSystemName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '操作系统',
  `LogGroup` int(11) DEFAULT 0 COMMENT '分组',
  `LogRemark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`LogId`) USING BTREE,
  INDEX `SysLog_LogCreateTime`(`LogCreateTime`) USING BTREE,
  INDEX `SysLog_LogId_PK`(`LogId`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
