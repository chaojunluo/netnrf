...
{
    public partial class netnrfContext : DbContext
    {
        public netnrfContext()
        {
        }

        public netnrfContext(DbContextOptions<netnrfContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("server=192.168.3.177;database=netnrf;uid=sa;pwd=123;");
            }
        }
